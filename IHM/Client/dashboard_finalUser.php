<?php
require_once '../../Traitement/Client/dashboard.php';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../../Traitement/Client/logout.php">Déconnexion</a>
                </li>
              </ul>
            </div>
          </nav>
          ...
          <div class="col-md-4 mb-3">
            <div class="card border-warning h-100">
              ...
              <div class="card-body">
                ...
                <a href="mes-reclamations.php" class="btn btn-warning btn-block mt-3">Faire une réclamation</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-3 col-6 mb-3">
                    <div class="card">
                      <?php if (!empty($photo['photo_compteur'])): ?>
                          <img src="../../<?= htmlspecialchars($photo['photo_compteur']) ?>" alt="Photo compteur" style="max-width: 300px;">
