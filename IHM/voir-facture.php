...
<body>
  <div class="container py-5">
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-6">
        <div class="facture-header">
          <h4><?= htmlspecialchars($client['nom']) ?></h4>
    ...
    <div class="row mb-4">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <?php if ($consommation && $consommation['photo_compteur']): ?>
            <div class="row mb-4">
              <div class="col-12">
                <h5>Photo du compteur</h5>
                <img src="<?= htmlspecialchars($consommation['photo_compteur']) ?>" class="img-fluid rounded" style="max-height: 200px;">
              </div>
            </div>
            <?php endif; ?>
